...
export default function ShirtFaceSwapPage({ params }: FaceSwapPageProps) {
  ...
  // Get template data
  const template = productData.shirt.templates[params.template];
  if (!template) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-orange-50 to-red-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/shirts" className="text-orange-600 hover:text-orange-700">← Back to Shirts</Link>
        </div>
      </div>
    );
  }
  ...
  const handleSwapNow = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/shirt-face-swap', {
        method: 'POST',
        body: formData,
      });
  ...
  const addToCart = () => {
    ...
    const cartItem = {
      id: `shirt-${params.template}-${Date.now()}`,
      type: 'shirt',
      ...
      <section className="bg-white border-b">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <nav className="text-sm">
            ...
            <Link href="/shirts" className="text-gray-500 hover:text-orange-500">Shirts</Link>
            <span className="mx-2 text-gray-400">/</span>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 md:p-12 bg-white hover:bg-gray-50 transition-colors">
                  {uploadedImageUrl ? (
                    ...
                    <div>
                      ...
                      <div className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-200 transform hover:scale-105 inline-block">
                        Choose File
                      </div>
                    </div>
                  )}
              ...
              {isSwapping && (
                <div className="mt-8 text-center">
                  <div className="bg-white rounded-lg shadow-xl p-8">
                    ...
                    <h3 className="text-2xl font-bold text-gray-800 mb-2">Creating Your Shirt...</h3>
            ...
            <div className="mb-16">
              <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                <div className="relative w-full aspect-[3/4] max-w-md mx-auto">
                  <Image src={watermarkedResult} alt="Your custom shirt" fill className="object-contain" />
                </div>
                <div className="p-6 text-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Link
                      href="/cart"
                      className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-lg font-bold transition-all duration-200 transform hover:scale-105 text-center"
                    >
                      💳 Buy Now
                    </Link>
                  </div>
